...
public class SwerveDrive {
  ...
  /**
   * Construct a swerve drive object with a navX gyro. This takes in four configured swerve
   * modules, by convention in left front, right front, left rear, right rear order.
   *
   * @param swerveModules the swerve modules
   */
  ...
  /**
   * Returns the current gyro-measured heading of the robot. This will be affected by any gyro
   * drift that may have accumulated since last gyro recalibration.
   *
